...
// PlaceOrderEndpoint executes the core logic of the related
// route endpoint.
func PlaceOrderEndpoint(handler func(ctx *gin.Context, params *PlaceOrderParams) *app.Response) gin.HandlerFunc {
...
func (o *PlaceOrderParams) readRequest(ctx *gin.Context) error {
	var res []error
