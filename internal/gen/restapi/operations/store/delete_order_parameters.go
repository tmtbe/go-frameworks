...
// DeleteOrderEndpoint executes the core logic of the related
// route endpoint.
func DeleteOrderEndpoint(handler func(ctx *gin.Context, params *DeleteOrderParams) *app.Response) gin.HandlerFunc {
...
func (o *DeleteOrderParams) readRequest(ctx *gin.Context) error {
	var res []error
