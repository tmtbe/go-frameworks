...
// AddPetEndpoint executes the core logic of the related
// route endpoint.
func AddPetEndpoint(handler func(ctx *gin.Context, params *AddPetParams) *app.Response) gin.HandlerFunc {
...
func (o *AddPetParams) readRequest(ctx *gin.Context) error {
	var res []error
